...
<head>
       ...
       <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
		...
		<div class="section section-breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<center><h1>Please sumbit the payin slip and finish your admission for swimming pool.</h1></center>
					</div>
				</div>
			</div>
		</div>
    ...
    <tr><div class='heading_pos'><center><b>SWIMMING POOL CENTER</b></br>ADMISSION FORM FOR SWIMMING-POOL</br>STUDENTS/TEACHERS/STUFF/OUTSIDER</center></div></tr>

	</table> 
	</center>
	</div>
	<div class='subject_div'>
	<label class="designation_label"><u>Please Submit the paying slip for Swimming pool admission.</u> </label>
	</div>
	<br><br>
	<table>
