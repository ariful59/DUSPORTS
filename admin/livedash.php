            ...
            <nav class="navbar navbar-default navbar-fixed">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="live">Live Football</a>
                    </div>
                ...
                <div class="form">
                    <form action="submit_football.php" method="post">
                        ...
                        <input type="text" placeholder="Enter team_name" name="team_name"><input type="text"
                                                                                                 placeholder="Enter goal giver name"
                                                                                                 name="goal_giver">
                        <br>
