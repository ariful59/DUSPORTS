            ...
            <div class="div_news">
                <form action="submit_news.php" method="post" class="news_form">
                    ...
                    <div class="news_enter">
                        <h1>Enter News</h1>
                        <input type="text" class="news" placeholder="Enter a news" name="news"
                        ...
                        <button type="submit" value="Enter News" name="enter_button"
                                style="color:#ffffff;background-color: #233028; height: 50px; width: 100px;">Enter News
                        </button>
                    </div>

                    <div class="news_delete">
                        <h1>Delete News</h1>
                        <input type="text" class="date" placeholder="Enter news no"
                               style="height:50px; font-size: 18px;" name="news_no"><br>

                        <button type="submit" value="Delete News" name="delete_button"
                                style="color:#ffffff;background-color: #233028; height: 50px; width: 100px;">Delete News
                        </button>
                    </div>
