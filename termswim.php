...
<head>
    <title>Term and Policies of Swimming Pool</title>
    ...
    <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
                    ...
                    <li><a href="admissionswim">ADMISSION</a></li>
					 <li class="active" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li  class="active"><a href="termswim">TERMS & POLICY</a></li>
		...
		<div class="section section-breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<center><h1>SWIMMING POOL TERM AND POLICIES</h1></center>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="schedule">
		   <img src="img/termswim.jpg" alt="Schedue" style="width:100%;height:80%;" class="imageSchedule">
		  </div>
