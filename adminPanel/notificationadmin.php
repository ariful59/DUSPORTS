    ...
    <div class="main-panel">
		...
		<div class="div_notice">
			...
			<div class="notice_enter">
				<h2>Enter Notice</h2>
				<input type="text" class="notice" placeholder="Enter a notice" name="notice" style="height:100px; width: 50%; font-size: 20px;"><br>
				<input type="text" class="date" placeholder="Enter date" name="date" style="height:50px; width: 30%; margin-top: 20px; font-size: 18px;"><br>

				<button type="submit" value="Enter News" name="enter_button" style="color:#ffffff;background-color: #233028; height: 50px; width: 100px;">Enter Notice</button>
			</div>

			<div class="notice_delete">
				<h2>Delete Notice</h2>
				<input type="text" class="date" placeholder="Enter notice no" style="height:50px; font-size: 18px;" name="notice_no"><br>

				<button type="submit" value="Delete News" name="delete_button" style="color:#ffffff;background-color: #233028; height: 50px; width: 100px;">Delete Notice</button>
			</div>
