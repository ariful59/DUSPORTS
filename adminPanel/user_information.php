                       ...
                       $conn = new mysqli('localhost', 'dusports', 'dusports', 'dusports');
                        ...
                        ?>
                            <div class="content table-responsive table-full-width">
                                    <center><h3>User Swimming Pool Details</h3></center>
                        ...
                        <?php
                            ...
                            echo "<tr><td>Guardian Address</td><td>" . $row['guardian_address'] . "</td></tr>";
                            echo "<tr><td>Phone</td><td>" . $row['phone'] . "</td></tr>";
                            echo "<tr><td>Birth of Date</td><td>" . $row['date_of_birth'] . "</td></tr>";
                            echo "<tr><td>High Blood Pressure</td><td>" . $row['high_blood_pressure'] . "</td></tr>";
                            echo "<tr><td>Epilepsy</td><td>" . $row['epilepsy'] . "</td></tr>";
                            echo "<tr><td>Asthoma</td><td>" . $row['asthoma'] . "</td></tr>";
                            echo "<tr><td>Skin Dieases</td><td>" . $row['skin_dieases'] . "</td></tr>";
                            echo '
                                <tr>
                                <tr><td>User Photo</td>
                                <td>
                             ...
                             $sql="SELECT * FROM admin_swim where email='$email'";
