        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href=".">HOME</a></li>
					<li class="active"><a href="gym">GYMNESIUM</a></li>
                    <li><a href="LoginCheckgym">ADMISSION</a></li>
	...
	<section id="main-slider" class="no-margin">
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="item active" style="background-image: url(img/slides/gym1.jpg)">
                </div>
                <div class="item" style="background-image: url(img/slides/gym2.jpg)">
                </div>
                <div class="item" style="background-image: url(img/slides/gym3.jpg)">
                </div>
            </div>
        </div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="calltoaction-wrapper">
							<h3>WELCOME TO <span style="color:#aec62c; text-transform:uppercase;font-size:24px;">UNIVERSITY OF DHAKA</span> GYMNESIUM</h3> 
