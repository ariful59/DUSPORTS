        ...
        <div class='fullFormcon'>
            <div class='panel panel-primary dialog-panel' style='background-color:#dbe8ff'>
                <div class='panel-body'>
                    ...
                    <form class='form-horizontal' id='form' role='form' action="confirmgymdata" method="POST"
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <div class='heading_pos'>
                                            <center><b>GYMNASIUM CENTER</b></br>ADMISSION FORM FOR GYMAESIUM</br>
                ...
                <div class='subject_div'>
                    <label class="designation_label"><u>Please Submit the paying slip for Gymnasium admission.</u>
                    </label>
                </div>
                <br><br>
                <table>
