...
<head>
    <title>DU Gymnasium Admission</title>
       ...
       <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
		...
		<div class="section section-breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<center><h1>Please sumbit the payin slip and finish your admission for Gymnasium.</h1></center>
					</div>
				</div>
			</div>
		</div>
    ...
    <form class='form-horizontal' id='form' role='form' action="confirmgymdata" method="POST" enctype="multipart/form-data">
	<center>
	<div class='image_pos_con'>	
	<table>
    <tr><center><img src="img/portfolio/logodu.jpg" height="100" width="80"/></center></tr><br>
    <tr><div class='heading_pos'><center><b>GYMNASIUM CENTER</b></br>ADMISSION FORM FOR GYMAESIUM</br>STUDENTS/TEACHERS/STUFF/OUTSIDER</center></div></tr>

	</table> 
	</center>
	</div>
	<div class='subject_div'>
	<label class="designation_label"><u>Please Submit the paying slip for Gymnasium admission.</u> </label>
	</div>
	<br><br>
	<table>
	<tr><div class='heading_pos'>
